...
createTimeDiscretization(BaseLib::ConfigTree const& config)
{
    ...
    //! \ogs_project_file_parameter{process__time_discretization__type}
    ...
    if (type == "BackwardEuler") {
        ...
        //! \ogs_project_file_parameter{process__time_discretization__CrankNicolson__theta}
        ...
        //! \ogs_project_file_parameter{process__time_discretization__BackwardDifferentiationFormula__order}
