...
{
const double DensityLegacy::M_Ads =
    MaterialLib::PhysicalConstant::MolarMass::Water;

double DensityLegacy::getAdsorbateDensity(const double T_Ads)
{
...
double DensityLegacy::getAlphaT(const double T_Ads)
{
    // set reference state for adsorbate EOS in Hauer
...
double DensityLegacy::characteristicCurve(const double A)
{
...
double DensityLegacy::dCharacteristicCurve(const double A)
{
