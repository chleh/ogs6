...
{
const double Density100MPa::M_Ads =
    MaterialLib::PhysicalConstant::MolarMass::Water;

double Density100MPa::getAdsorbateDensity(const double T_Ads)
{
    return -0.0013*T_Ads*T_Ads + 0.3529*T_Ads + 1049.2;
}

// Thermal expansivity model for water found in the works of Hauer
double Density100MPa::getAlphaT(const double T_Ads)
{
...
double Density100MPa::characteristicCurve(const double A)
{
...
double Density100MPa::dCharacteristicCurve(const double A)
{
