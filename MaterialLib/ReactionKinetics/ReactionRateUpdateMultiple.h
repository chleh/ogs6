...
#ifndef MATERIALLIB_REACTIONRATEUPDATEMULTIPLE_H
#define MATERIALLIB_REACTIONRATEUPDATEMULTIPLE_H
...
{
class ReactionRateUpdateMultiple final : public ReactionRate
{
public:
    ReactionRateUpdateMultiple(double eq_react_lim, double upper_pV_lim,
...
private:
    double computeEquilibriumVapourPressure(const double p, const double T,
                                            const double rhoSR) const;
...
#endif  // MATERIALLIB_REACTIONRATEUPDATEMULTIPLE_H
