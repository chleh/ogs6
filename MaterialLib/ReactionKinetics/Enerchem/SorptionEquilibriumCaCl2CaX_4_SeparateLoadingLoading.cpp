...
{
void SorptionEquilibriumCaCl2CaX_4_SeparateLoadingLoading::getEquilibrium(
    const double p_Ads,
    const double T_Ads,
...
HeatOfReactionData
SorptionEquilibriumCaCl2CaX_4_SeparateLoadingLoading::getHeatOfReaction(
    const double p_Ads,
    const double T_Ads,
...
SorptionEquilibriumCaCl2CaX_4_SeparateLoadingLoading::getNamedFunctions() const
{
    ...
    auto pV_del = [](double T) -> double { return CaCl2_p_V_deliquescence(T); };
    ...
    return {{"equilibrium_loading1",
            ...
            {"deliquescence_pressure",
             {"temperature"},
             BaseLib::easyBind(std::move(pV_del))}};
}

std::unique_ptr<SorptionEquilibriumCaCl2CaX_4_SeparateLoadingLoading>
createSorptionEquilibriumCaCl2CaX_4_SeparateLoadingLoading(
    BaseLib::ConfigTree const& config)
{
    config.checkConfigParameter("type", "CaCl2CaX_4_SeparateLoadingLoading");

    auto const salt_loading = config.getConfigParameter<double>("salt_loading");

    return std::unique_ptr<
        SorptionEquilibriumCaCl2CaX_4_SeparateLoadingLoading>{
        new SorptionEquilibriumCaCl2CaX_4_SeparateLoadingLoading{salt_loading}};
}
