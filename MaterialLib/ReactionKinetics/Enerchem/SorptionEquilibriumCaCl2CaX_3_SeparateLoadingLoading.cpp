                                                ...
                                                const double salt_loading)
{
    ...
    {  // deliquescence
        ...
        // Auswaschung des Salzes ignorieren!
        s_i = salt_loading;
    }
...
{
void SorptionEquilibriumCaCl2CaX_3_SeparateLoadingLoading::getEquilibrium(
    const double p_Ads,
    const double T_Ads,
...
HeatOfReactionData
SorptionEquilibriumCaCl2CaX_3_SeparateLoadingLoading::getHeatOfReaction(
    const double p_Ads,
    const double T_Ads,
...
SorptionEquilibriumCaCl2CaX_3_SeparateLoadingLoading::getNamedFunctions() const
{
...
{
    config.checkConfigParameter("type", "CaCl2CaX_3_SeparateLoadingLoading");
    ...
    return std::unique_ptr<
        ...
        new SorptionEquilibriumCaCl2CaX_3_SeparateLoadingLoading{salt_loading}};
}
