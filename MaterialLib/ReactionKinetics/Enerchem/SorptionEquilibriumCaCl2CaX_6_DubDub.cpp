...
#include "SorptionEquilibriumCaCl2CaX_6_DubDub.h"
...
{
double SorptionEquilibriumCaCl2CaX_6_DubDub::getEquilibriumDensity(
...
double SorptionEquilibriumCaCl2CaX_6_DubDub::getDEquilibriumDensityDp(
...
double SorptionEquilibriumCaCl2CaX_6_DubDub::getEquilibriumLoading(
...
double SorptionEquilibriumCaCl2CaX_6_DubDub::getMaximumLoading(
...
double SorptionEquilibriumCaCl2CaX_6_DubDub::getLoading(
    const double adsorbent_density) const
{
    return adsorbent_density / _rho_SR_dry - 1.0;
}

HeatOfReactionData SorptionEquilibriumCaCl2CaX_6_DubDub::getHeatOfReaction(
    const double /*p_Ads*/, const double T_Ads,
...
double SorptionEquilibriumCaCl2CaX_6_DubDub::getHeatOfReactionImpl(
...
double SorptionEquilibriumCaCl2CaX_6_DubDub::getEntropy(const double T_Ads,
...
SorptionEquilibriumCaCl2CaX_6_DubDub::getNamedFunctions() const
{
    return {{"equilibrium_loading",
             {"adsorptive_partial_pressure", "adsorbent_temperature"},
             BaseLib::easyBind(
                 &SorptionEquilibriumCaCl2CaX_6_DubDub::getEquilibriumLoading,
                 *this)},
            {"loading",
             {"adsorbent_density"},
             BaseLib::easyBind(
                 &SorptionEquilibriumCaCl2CaX_6_DubDub::getLoading, *this)},
            {"heat_of_reaction",
             {"adsorbent_temperature", "adsorbent_density"},
             BaseLib::easyBind(
                 &SorptionEquilibriumCaCl2CaX_6_DubDub::getHeatOfReactionImpl,
                 *this)}};
}
...
{
    config.checkConfigParameter("type", "SorptionEquilibriumCaCl2CaX_6_DubDub");
    ...
    return std::unique_ptr<SorptionEquilibriumCaCl2CaX_6_DubDub>(
        new SorptionEquilibriumCaCl2CaX_6_DubDub(rho_SR_dry, salt_loading));
}
