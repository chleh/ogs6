...
#include "CreateIncompressibleStokesBrinkmanModifiedProcess.h"
...
std::unique_ptr<Process> createIncompressibleStokesBrinkmanModifiedProcess(
    MeshLib::Mesh& mesh,
    ...
    BaseLib::ConfigTree const& config)
{
    ...
    NumLib::NamedFunctionCaller named_function_caller(
        {"IncompressibleStokesBrinkmanModified_pressure",
         "IncompressibleStokesBrinkmanModified_velocity"});
