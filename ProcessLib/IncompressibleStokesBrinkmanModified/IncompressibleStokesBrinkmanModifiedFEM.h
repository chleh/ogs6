...
class IncompressibleStokesBrinkmanModifiedLocalAssembler
...
public:
    ...
    IncompressibleStokesBrinkmanModifiedLocalAssembler(
        IncompressibleStokesBrinkmanModifiedLocalAssembler&&) = delete;
    ...
    IncompressibleStokesBrinkmanModifiedLocalAssembler(
        ...
        IncompressibleStokesBrinkmanModifiedProcessData<VelocityDim>&
            process_data);
...
private:
    IncompressibleStokesBrinkmanModifiedProcessData<VelocityDim>& _process_data;
...
#include "IncompressibleStokesBrinkmanModifiedFEM-impl.h"
