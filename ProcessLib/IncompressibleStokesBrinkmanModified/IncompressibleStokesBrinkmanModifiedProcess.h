...
class IncompressibleStokesBrinkmanModifiedProcess final : public Process
{
    using Base = Process;
...
extern template class IncompressibleStokesBrinkmanModifiedProcess<2>;
extern template class IncompressibleStokesBrinkmanModifiedProcess<3>;
