...
#include "ProcessLib/IncompressibleStokesBrinkmanModified/CreateLocalAssemblers.h"
#include "ProcessLib/Process.h"

#include "IncompressibleStokesBrinkmanModifiedFEM.h"
#include "IncompressibleStokesBrinkmanModifiedProcess.h"
#include "IncompressibleStokesBrinkmanModifiedProcessData.h"
...
IncompressibleStokesBrinkmanModifiedProcess<DisplacementDim>::
    IncompressibleStokesBrinkmanModifiedProcess(
        MeshLib::Mesh& mesh,
...
template <int DisplacementDim>
bool IncompressibleStokesBrinkmanModifiedProcess<DisplacementDim>::isLinear()
    const
{
    return false;
}
...
template <int DisplacementDim>
MathLib::MatrixSpecifications IncompressibleStokesBrinkmanModifiedProcess<
    DisplacementDim>::getMatrixSpecifications(const int process_id) const
{
...
void IncompressibleStokesBrinkmanModifiedProcess<
    DisplacementDim>::constructDofTable()
{
...
template <int DisplacementDim>
void IncompressibleStokesBrinkmanModifiedProcess<DisplacementDim>::
                              ...
                              unsigned const integration_order)
{
    ...
    ProcessLib::IncompressibleStokesBrinkmanModified::createLocalAssemblers<
        DisplacementDim, IncompressibleStokesBrinkmanModifiedLocalAssembler>(
...
void IncompressibleStokesBrinkmanModifiedProcess<
    DisplacementDim>::assembleConcreteProcess(const double t,
                                              ...
                                              GlobalVector& b)
{
    DBUG("Assemble the equations for IncompressibleStokesBrinkmanModified");
                                        ...
                                        GlobalMatrix& Jac)
{
    ...
    {
        DBUG(
            "Assemble the Jacobian of IncompressibleStokesBrinkmanModified for "
            "the "
            "monolithic"
            " scheme.");
    ...
    else
    {
        ...
        if (_coupled_solutions->process_id == 0)
        {
            DBUG(
                ...
                "IncompressibleStokesBrinkmanModified for the staggered "
                "scheme.");
        }
        else
        {
...
{
    DBUG("PreTimestep IncompressibleStokesBrinkmanModifiedProcess.");
                                                         ...
                                                         const int process_id)
{
    ...
    DBUG("PostNonLinearSolver IncompressibleStokesBrinkmanModifiedProcess.");
...
IncompressibleStokesBrinkmanModifiedProcess<DisplacementDim>::getDOFTable(
