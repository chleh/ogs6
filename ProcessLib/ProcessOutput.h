...
struct ProcessOutput final
{
    ...
    {
        //! \ogs_project_file_parameter{process__output__variables}
        auto const out_vars = output_config.getConfSubtree("variables");

        //! \ogs_project_file_parameter{process__output__variables__variable}
        ...
        // debug output
        if (auto const param =
            //! \ogs_project_file_parameter{process__output__output_iteration_results}
