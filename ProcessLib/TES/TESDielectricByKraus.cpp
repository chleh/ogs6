...
// properties of the NaY zeolite, see also p. 132ff
const double radio_freq = 13.56e6;  // Hz

const double t_relax0_II_HF = 5e-15;   // s ; p. 62 bottom
const double t_relax0_III_HF = 2e-12;  // s ; p. 60

const double diff_eps_II_HF = 0.2;    // no unit ; p. 62 bottom
const double diff_eps_III_HF = 0.54;  // no unit ; p. 60

const double EA_II_HF = 0.74 * electron_charge;  // J ; p. 58

const double a_Vert = -1.18;  // (Ma.-%)^-1 ; p. 62
