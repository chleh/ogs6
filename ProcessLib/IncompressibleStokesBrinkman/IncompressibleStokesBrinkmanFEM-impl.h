...
IncompressibleStokesBrinkmanLocalAssembler<ShapeFunctionDisplacement,
...
template <typename ShapeFunctionDisplacement, typename ShapeFunctionPressure,
          typename IntegrationMethod, int DisplacementDim>
std::vector<double> const& IncompressibleStokesBrinkmanLocalAssembler<
    ShapeFunctionDisplacement, ShapeFunctionPressure, IntegrationMethod,
...
void IncompressibleStokesBrinkmanLocalAssembler<
    ShapeFunctionDisplacement, ShapeFunctionPressure, IntegrationMethod,
    DisplacementDim>::postNonLinearSolverConcrete(std::vector<double> const&
                                                      local_x,
                                                  double const t,
                                                  bool const
