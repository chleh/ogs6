...
class IncompressibleStokesBrinkmanProcess final : public Process
{
    using Base = Process;
...
private:
    ...
    IncompressibleStokesBrinkmanProcessData<DisplacementDim> _process_data;
...
extern template class IncompressibleStokesBrinkmanProcess<2>;
extern template class IncompressibleStokesBrinkmanProcess<3>;
